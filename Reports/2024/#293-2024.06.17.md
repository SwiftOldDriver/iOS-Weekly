...
[@JonyFang](https://github.com/JonyFang): 手 Q 的防劣化系统命名为Hodor系统，从2021年10月开始研发，历时近三年迭代至今。系统涉及验证闭环、群控机架搭建等复杂过程，包含不少行业内独创方案。与厂商合作进行底层问题沟通，并在2024年拓展至QQ桌面客户端。系统目前已在QQ各平台落地，方案可做借鉴。
