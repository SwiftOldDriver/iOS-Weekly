...
[@zoeGuo](https://github.com/zoeGuo)：这个网站直观地解释了 SwiftUI 布局系统的工作原理。可以通过变化属性或参数数值动态看到布局上的变化，更有利于理解 SwiftUI 参数、属性的含义。 网站目前更新了 [Alignment](https://www.swiftuifieldguide.com/layout/alignment)、[HStack](https://www.swiftuifieldguide.com/layout/hstack)、[Aspect Ratio](https://www.swiftuifieldguide.com/layout/aspect-ratio) 和 [Padding](https://www.swiftuifieldguide.com/layout/padding) 四个模块，推荐给正在学习 SwiftUI 的读者。
