...
[@CrazyCoderShi](https://github.com/CrazyCoderShi)：Flutter 自打发布以来一直是热门话题，对于新手入门来说，一个完整且规范的项目是不可多得的学习资料，[flutter_go](https://github.com/alibaba/flutter-go?utm_source=gold_browser_extension) 出自阿里拍卖前端团队，[flutter_ui](https://github.com/efoxTeam/flutter-ui) 『』 团队，两者均提供了丰富的组件示例，代码规范完全遵循 [Effective-Dart](https://www.dartlang.org/guides/language/effective-dart/style) 规范，新手入门 flutter 必备，通过这两个项目您将学习到以下知识点:
