...
**戴铭，绝对是 iOS 届的资深老司机，GMTC 全球大前端技术大会的专题出品人及讲师之一**，前滴滴出行技术专家，在组件化方案落地、工程动态化、大前端建设、应用开发阶段效率的提升、上线后各种难点问题的解决等方面的经验非常丰富。极客时间的品牌我一向比较认可，专栏品质很有保障，《iOS 开发高手课》也是戴铭老师对移动开发这么些年沉淀下来的技术，详细而系统的输出。我看了目录，主要分为基础、应用开发、原理、前端与原生共舞的4个模块，你将获得：
