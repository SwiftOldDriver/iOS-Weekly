...
### 🐎 [Sharing Swift code](https://www.swiftbysundell.com/posts/sharing-swift-code)

作为软件工程师我们经常需要分享自己的代码给同事或者开源社区等等，本文作者对如何清晰高效的分享代码给出了几点建议：

1. 语境很重要：通过有意义的类名函数名让代码容易被读懂。

2. 抓住重点：读者的时间是有限的，给出关键的示例代码，避免不必要的繁杂代码。

3. What, how, and why：在代码示例中体现是什么，如何做，为什么这样做。

4. 增加文档及单元测试：一定的文档注释和单元测试可以让代码更易懂更易于维护。
