...
2018 年移动端对于很多人来讲最值得学习的新框架就是 Flutter了。从 Flutter 在 Google I/O 上的正式亮相到年底时候正式发布 1.0 版本，Flutter 开始出现在越来越多的一线项目，主流产品中。如果你还没尝试过 Flutter，赶紧行动起来尝试一下吧。

本文介绍了 Flutter 渲染中的能够做到高性能渲染的原理，对于大家自己思考自己未来的构架设计上，有一定的参考价值。
