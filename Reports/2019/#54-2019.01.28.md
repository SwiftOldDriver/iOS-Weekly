...
### 🐎 [使用Flutter一年后，这是我得到的经验](https://mp.weixin.qq.com/s/FmK0RMCNNJe68Aq7tOUROA)

过去一年开发者们对 Flutter 的热情有多高相信已经无需多言。Googlec 出品、跨平台、性能高等种种标签让越来越多的人加入其中。本文总结了作者一年来开发 Flutter 的一些心得，作者在 Flutter 上丰富的开发经验所进行的总结相信对于接下来想要尝试 Flutter 的同学是很实用的，这对我们做技术选型以及更多的考虑会很有帮助。
