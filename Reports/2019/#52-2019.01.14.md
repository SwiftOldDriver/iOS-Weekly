...
本项目利用 CoreML 识别出摄像头拍到的物体，并利用 ARKit 为其加上 3D 标签，实现简单的 AR 效果。项目代码简单，创意好，非常适合入门，所以后来苹果官方也似乎借(chao)鉴(xi)了这个创意，推出了略有不同的官方 Demo：[Using Vision in Real Time with ARKit](https://developer.apple.com/documentation/arkit/using_vision_in_real_time_with_arkit)，供大家参考学习。
