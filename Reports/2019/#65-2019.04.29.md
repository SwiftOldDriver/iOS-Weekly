...
🐕 [@CrazyCoderShi](https://github.com/CrazyCoderShi): [Flutter 实时视频渲染](https://zhuanlan.zhihu.com/p/62821195)

Flutter 如火如荼的火了一段时间了，但鲜少有关于音视频方面的文章，本文是声网 Agora 的高级架构师张乾泽在 RTC Dev Meetup 上的分享，主要介绍 Agora 在 Flutter 实时音视频开发方面的实践经验，整个分享分三部分:
