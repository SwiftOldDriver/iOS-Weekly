...
### 🐎 [我开发了一个SwiftUI库，将CSS引入iOS开发](https://mp.weixin.qq.com/s/I0HMHBBzhxsKj528mUqXmg)
...
关注我们周报的读者相信对思琦（[@SketchK](https://github.com/SketchK)）都会有印象，因为他是我们目前 Logo 的设计者。这次 GGTalk 思琦和梁大一起聊了他是如何从石油相关专业转化成功到 iOS 开发的历程。
