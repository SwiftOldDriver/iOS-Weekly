...
在接下来的周报发布中，我们将会采用 GitHub 最新的 **GitHub Release** 特性进行，读者朋友们可以到我们 [GitHub 主页](https://github.com/SwiftOldDriver/iOS-Weekly#订阅周报) **点击 watch -> 选择 Release only**  即可订阅。之后每期周报发布，你 GitHub 账号关联的邮箱就会收到我们的发布邮件。
