...
[@Crazy](https://github.com/jiyan135960)：本文是一篇侧重于 Android 云编译方面的介绍性文章，讲解了云编译的流程与打包优化的方向。本文主要对 d8 的流程以及hook方案进行了分析与讲解，并且对编译的优化也提出了切实可行的方向性建议，值得有需要开发云编译平台或思考如何优化打包速度的同学进行学习与参考。
