...
[@Barney](https://github.com/BarneyZhaoooo)：本文是 Airbnb PPS 的第二部分，介绍了 PPS 在 iOS 端的具体实践应用，并配有重点代码思路分析，时间锚点的选取和状态机的丝滑运用让人眼前一亮。在介绍方案的同时，也给出了遇到的难点和方案应用后的效果展示，文章最后也介绍了所使用的前端性能监控的方案。
