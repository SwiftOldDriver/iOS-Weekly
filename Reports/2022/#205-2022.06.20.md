...
[@zvving](https://github.com/zvving)：响应式编程由来已久，苹果钦定的 Combine 正是 Reactive Streams 规范的一种实现。伴随着 SwiftUI 的推广，声明式布局+响应式编程因其简洁、直观、易测、易重用的优势逐步流行。本文正是字节跳动音乐团队在大项目中落地响应式编程的选型思考和最佳实践，非常值得参考。
