...
### 🐢 [美团客户端响应式框架EasyReact开源啦](https://mp.weixin.qq.com/s/TSu50PihKjy9rvg2zuF6bQ)
...
Twitter Network Layer (TNL) 是 Twitter 开源的一套基于 NSURLSession 的扩展性强且功能丰富的 iOS 网络层框架。据说该框架已经在 Twitter 内部使用了 4 年，并且有 18 个月没有出现过 bug，具体介绍可以看下 Twitter 官方发布的博客文章 🚧[Introducing Twitter Network Layer iOS framework for open source](https://blog.twitter.com/engineering/en_us/topics/open-source/2018/opensourcetnl.html)。
