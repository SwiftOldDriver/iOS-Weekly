...
```
但由于 Swift 泛型的限制 1 个属性包装器只能处理固定数量的返回参数，所以作者同时编写了开源库 [Delegated](https://github.com/dreymonde/Delegated) 提供 @Delegate0、@Delegate1、@Delegate2 等多个属性包装来支持不同参数数量的闭包。有兴趣的同学可以阅读原文了解。
