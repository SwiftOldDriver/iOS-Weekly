...
[@水水](https://www.xuyanlan.com): 在2020年10月的发布会上，苹果发布了四款 iphone12 机型：iphone12 mini、iphone12、iphone12 pro 和 iphone12 pro max。iphone12 和 12pro 的屏幕分辨率完全相同，行为也完全相同。所以只有三个屏幕分辨率要考虑，作者列举了这几个机型以及之前的一些机型的标准缩放和显示缩放, 希望对你的机型适配有所帮助。
