...
[@xiaofei86](https://weibo.com/xuyafei86)：在 WWDC20 "What's New in Swift" 公布 Swift Archive 框架时，提到其文件流构造函数用到了今年引入的另一个新库 Swift System。之后简单介绍 Swift System 为 Apple Archive 的系统底层 API，提供更加现代、易用的系统接口，以及更加底层、通用的类型。除此之外，没有公布更多的信息。
