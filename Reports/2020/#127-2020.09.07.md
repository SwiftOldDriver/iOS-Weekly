...
### 🐎 [多级 MVC 和项目最佳实践](https://github.com/zzyptr/App/b lob/master/README.md)

[@J_Knight_](https://weibo.com/1929625262/profile?rightmod=1&wvr=6&mod=personinfo&is_all=1)：为了解决在 UIViewController 之间存在依赖的问题，作者介绍了一种新的 MVC 方案：在 UIViewController 之上引入了一组新的 MVC 关系：将 Presenter 作为容器来整合 Controller，View；View通过 Coordinator 来向 Presenter 通信；而高一级的 Presenter 持有低级 Presenter，低级的 Presenter 通过 Coordinator 向高一级通信。结构如下：
