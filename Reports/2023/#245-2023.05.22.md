...
[@zoeGuo](https://github.com/zoeGuo)：作者介绍了 Swift 中 Range 的不同类型： ClosedRange、CountableClosedRange ，以及使用简易的操作符代替声明 Range 的使用方法和规则，并且就 Range 转化为 NSRange 举例演示。文章适合 Swift 新手快速了解 Range 的使用方法。
