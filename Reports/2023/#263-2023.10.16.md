...
[@AidenRao](https://weibo.com/AidenRao)：

这篇文章介绍了作者将他的开源Mastodon客户端Ice Cubes迁移到了新的Observation framework的过程。作者分享了一些关键点：

1. 迁移并不复杂，作者只花了几个小时就完成了。
2. 迁移修复了一些bug，并不会引入新的问题。
3. 性能改进明显，值得投入。
