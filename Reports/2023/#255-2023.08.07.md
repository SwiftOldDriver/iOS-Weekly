...
@zoeGuo：TipKit 是 WWDC23 上发布的新的 UI 组件库：[Make features discoverable with TipKit](https://developer.apple.com/videos/play/wwdc2023/10229/)，[TipKit-Examples](https://github.com/jordibruin/TipKit-Examples) 是一个不错的使用 TipKit 的示例代码，感兴趣的读者可以自行阅读源码。
