...
### 🌟 [WWDC 21 内参](https://xiaozhuanlan.com/wwdc21)：https://xiaozhuanlan.com/wwdc21
...
[@红纸](https://github.com/nianran)：编译加速通常有两种方案二进制化和源码编译缓存，相较于二进制化，源码编译能解决二进制化带来的问题：编译宏问题、函数不存在等一系列问题。文中，作者使用 XCache 来做缓存机制。使得每次编译都是增量编译而不是全量编译~感兴趣的同学可以看下作者的适配历程~
