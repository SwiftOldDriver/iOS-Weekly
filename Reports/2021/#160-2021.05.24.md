...
## [摸鱼周报](https://zhangferry.com/2021/05/22/iOSWeeklyLearning_12/)

[@摸鱼周报](https://github.com/zhangferry/iOSWeeklyLearning)：本期摸鱼周报带来了 `程序员必知的硬核知识大全` 的第二部分内容，包含对：二进制、大小端、缓存、压缩算法等内容的介绍。

另外我们还总结了一些 Xcode 耗时统计的几个Tips；博客的筛选偏向于主题形式的汇总，除了近期几篇热门且比较重要的文章外，本期还收录了几篇 weakup 崩溃相关的文章，便于大家对这一知识有更全面的认识；资料部分收录了一个很不错的网站：swiftbysundell.com，它由 [John Sundell](https://twitter.com/johnsundell) 创建，主要内容是关于 `Swift` 开发的文章、播客和新闻。
