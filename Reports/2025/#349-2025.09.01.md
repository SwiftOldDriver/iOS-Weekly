...
[@AidenRao](https://weibo.com/AidenRao)：iOS 26 的同心圆角（Corner Concentricity）是苹果在 WWDC 2025 上强调的一项重要设计理念和视觉特性。同心圆角的核心思想是**让嵌套的 UI 元素具有和谐一致的圆角**，即使它们的大小或层级不同，其圆角的视觉“圆心”也尽可能保持一致，从而营造出统一、精致且富有纵深感的界面效果。
