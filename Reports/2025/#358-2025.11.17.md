...
![ios-weekly](https://github.com/SwiftOldDriver/iOS-Weekly/blob/master/assets/weekly-header/358.jpg?raw=true)
...
### [objc4-950 源码更新](https://github.com/apple-oss-distributions/objc4/blob/6dee1d79e3825de8c284a422faad4035f958346c/runtime/NSObject.mm#L269)

Runtime 的源码发布新版本，主要更新的是 Xcode26 的 objc_storeStrong 的逻辑，有兴趣可以自行查看。

### [App Store Mini App Partner Program 隆重推出](https://developer.apple.com/news/?id=xcz1s7cz)

参与计划的开发者在销售符合条件的 App 内购买项目时，可享受 15% 的收益抽成减免。需要适配 Advanced Commerce API (ACA) 。微信已经发[公告](https://mp.weixin.qq.com/s/ZjeVjjh9VfNNr6OC56PtTA)预计会进行接入，期待后续更多中国公司都能同样谈成优惠，让更多增值业务在 iOS 端上线。
...
### 🐎 [来了解一下，为什么你的 Flutter WebView 在 iOS 26 上有点击问题？](https://mp.weixin.qq.com/s/Y-jbx2i6z8fgsDD7bEt2kQ)

[@david-clang](https://github.com/david-clang)：iOS 26 上 WebView 点击失效，核心仍是 iOS 18.2 起 WKWebView 的手势状态缓存问题。
...
解决方案：
- **短期规避**：使用 [pointer_interceptor](https://pub.dev/packages/pointer_interceptor) 在 WebView 上方覆盖一个透明层，阻止 overlay 引发的手势中断，从而避免点击失效。
