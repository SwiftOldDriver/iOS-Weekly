...
@zhangferry：Xcode 原始构建日志对人和 AI 都不够友好，仅提供扁平信息输出。作者通过截获 Xcode 与 SWBBuildService 的通信，挖掘出日志之外的结构化数据，包括构建依赖、详细耗时等核心信息，现在随着 [swift-build](https://github.com/swiftlang/swift-build) 的开源，可以更系统的了解这些构建信息，利用它们可以实现这些功能：
