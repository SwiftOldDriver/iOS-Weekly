...
@JonyFang：官方 TSPL 一直是查语法、补语言特性和带新人入门的标准参考，但 [docs.swift.org](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/) 通常只提供当前版本。这个站点用 VersionedDocC 按 Swift 发行标签重新构建了同一本书，页头可以直接在 `main`（6.4 beta）、6.3、6.2.x、6.1、6、5.10 一直到 5.7 共 12 个版本之间切换，每个版本都有稳定 URL。
