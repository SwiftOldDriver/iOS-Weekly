...
### 🐎 [Universal Links At Scale: The Challenges Nobody Talks About ](https://albertodebortoli.com/2026/01/15/universal-links-at-scale-the-challenges-nobody-talks-about/)
...
### 🐕 [How I use Codex GPT 5.2 with Xcode (My Complete Workflow)](https://www.youtube.com/watch?v=o4iKnSYlhBQ)

[@JonyFang](https://github.com/JonyFang): 本视频深入介绍了如何让 AI 代理（如 Codex GPT 5.2）真正提升 iOS/macOS 开发效率的三个核心策略：
...
[@Crazy](https://github.com/jiyan135960)：Skip 框架正式免费并且开源，该库从 2023 年开始开发，已有三年的开发历程。该库的目的是让开发者能够仅用一套 Swift 与 SwiftUI 代码库，同时打造 iOS 与 Android 上的高品质移动应用——而且不必接受那些自“跨平台工具诞生以来就一直存在”的妥协。因为 Skip 是采用编译为 Kotlin 与 Compose 的方式，所以相应的执行效率是非常高的。相较于其他的跨平台开发，效率高，并且使用的是 Swift 语言。既然已经免费并开源，移动端开发的时候又多了一个可供选择的跨端技术。
