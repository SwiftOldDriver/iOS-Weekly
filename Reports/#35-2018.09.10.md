...
本文对大家熟悉的 iOS 并发编程的基本概念、基本用法和常见问题进行了总结，最后还通过一个具体的开发例子来说明 Operation 的一个特别好的使用场景 —— 高度封装的流程化开发。

全文从枯燥的概念到最后的实践案例，把理论通过示例描述的浅显易懂，这是一个相当不错的分享，看得出道长本人的精心准备，非常值得大家细细体会。
